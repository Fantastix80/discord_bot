...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="🛠️ !say <message>", value="Permet d'envoyer un message sur le serveur minecraft.\nSeulement utilisable dans le channel `minecraft` !", inline=False)
